...
public class CPUSchedulerFrameForApplet extends JFrame implements ActionListener {
    ...
    JRadioButtonMenuItem  fcfsRB,sjfRB,rrRB,priRB,mlpRB;
...
*/
	...
	mlpRB = new JRadioButtonMenuItem("Multilevel Priority");
	mlpRB.setToolTipText("Multilevel weighted scheduling");
	mlpRB.addActionListener(this);
	algogroup.add(mlpRB);
	algorithmMenu.add(mlpRB);
